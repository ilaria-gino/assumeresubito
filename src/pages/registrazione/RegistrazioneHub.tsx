...
export function RegistrazioneHub() {
  ...
  return (
    <PremiumPageShell
      ...
      subtitle={`Scegli un percorso. ${BRAND.name} non è un'agenzia per il lavoro: bacheca digitale per incontrare in autonomia chi cerca personale e chi cerca lavoro — senza collocamento e senza contratti di lavoro con noi. Su ogni pagina: modulo e costi affiancati (${BRAND.domain}).`}
      maxWidth="wide"
    >
      ...
      <p className="mt-10 text-center text-sm text-[#152435]/75">
        ...
        (tempi orientati alle 48 ore ove applicabile; filtri per settore e zona — corrispondenza tra annunci e profili, a
        cura degli utenti).
      </p>
    </PremiumPageShell>
  );
